        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ListingEndDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "(NOW() + INTERVAL '7 days')"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SellerResponseAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 9, 2, 11, 1, 45, 373, DateTimeKind.Utc).AddTicks(259), "Fashion, apparel, and accessories", "🧥", true, "Clothing", null, "clothing", 1 },
                    { 2, new DateTime(2026, 9, 2, 11, 1, 45, 373, DateTimeKind.Utc).AddTicks(264), "Phones, laptops, gadgets", "📱", true, "Electronics", null, "electronics", 2 },
                    { 3, new DateTime(2026, 9, 2, 11, 1, 45, 373, DateTimeKind.Utc).AddTicks(267), "Food items and beverages", "🥤", true, "Food & Drinks", null, "food-drinks", 3 },
                    { 4, new DateTime(2026, 9, 2, 11, 1, 45, 373, DateTimeKind.Utc).AddTicks(270), "Home and office furniture", "🛋️", true, "Furniture", null, "furniture", 4 },
                    { 5, new DateTime(2026, 9, 2, 11, 1, 45, 373, DateTimeKind.Utc).AddTicks(272), "Tools and building materials", "🔧", true, "Hardware", null, "hardware", 5 },
                    { 6, new DateTime(2026, 9, 2, 11, 1, 45, 373, DateTimeKind.Utc).AddTicks(275), "Sports equipment and fitness gear", "🏋️", true, "Sport & Fitness", null, "sport-fitness", 6 },
                    { 7, new DateTime(2026, 9, 2, 11, 1, 45, 373, DateTimeKind.Utc).AddTicks(277), "Cosmetics and health products", "💄", true, "Beauty & Health", null, "beauty-health", 7 },
                    { 8, new DateTime(2026, 9, 2, 11, 1, 45, 373, DateTimeKind.Utc).AddTicks(280), "Everything else", "📦", true, "Other", null, "other", 8 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2026, 9, 2, 11, 1, 45, 372, DateTimeKind.Utc).AddTicks(8730), "admin@inventoryzero.com", "System Administrator", true, true, false, null, "$2a$11$W/pBnkq8iFPcBXdlhofPaeez4vlzQk0EGesyNKqrtHcqkRoN3yDCa", null, null, 0m, "Admin", null, null, 0 });
